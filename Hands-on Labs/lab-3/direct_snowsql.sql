...
CREATE OR REPLACE TABLE BEETLE_DB.BEETLE_SCHEMA.BEETLE_TBL (
id NUMBER(38,0),
name STRING(10),
country VARCHAR(20),
order_date DATE);
...
INSERT INTO BEETLE_TBL VALUES(2, 'A','UK', '11/02/2005');
INSERT INTO BEETLE_TBL VALUES(4, 'C','SP', '11/02/2005');
INSERT INTO BEETLE_TBL VALUES(3, 'C','DE', '11/02/2005');
